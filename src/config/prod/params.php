...
//构建目录名称
define('GULP', 'dist');
define('CDN_URL', '//cdn.mutantbox.com/01/04');
...
return [
    ...
    'pay'                 => PROTOCOL.'://pay.bycouturier.com',
    ...
    'MY_URL'=>array(
        'PAY'  => PROTOCOL.'://pay.bycouturier.com',
        'PAYS' => 'https://pay.bycouturier.com',
        'UCENTER' => PROTOCOL.'://ucenter.bycouturier.com',
        'EMAIL'=>'http://message.mutantbox.com',
        'ShopPay_1' => PROTOCOL.'://pay.clothesforever.com',
        'ShopPay_2' => PROTOCOL.'://pay.lovecrunch.com',
        'ShopPay_bycouturier' => PROTOCOL.'://pay.bycouturier.com',
        'CF'=> PROTOCOL.'://www.clothesforever.com',
        'LC'=> PROTOCOL.'://www.lovecrunch.com',
        'BS'=> PROTOCOL.'://www.bycouturier.com',
        'MUTANTBOX'=>PROTOCOL.'://www.mutantbox.com',
        'M'=> PROTOCOL.'://m.bycouturier.com',
    ),
    'TOKEN' => array(
        'KEY'=>'uow)*^$@!#%&456kj',
    ...
    'edm' => 'http://message.mutantbox.com',
];
