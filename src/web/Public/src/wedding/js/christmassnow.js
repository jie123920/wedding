...
// Establish our default settings
        ...
        this.each(function() {
            ...
            var droo = jQuery('.droo').detach();
            var snowTop = Math.floor(Math.random() * (windowHeight));
            snowTop = 0;
            var header = document.getElementsByTagName("head")[0];
            $(header).append('<style type="text/css">.droo{position: fixed;color:#fff;z-index:999999;}</style>');
            function create() {
                ...
                for (var i = 1; i <= 25; i++) {                                                                                     
                    if (settings.snowflaketype === i) {
                        if (i === 21) {
                            content = '<img class="flakeimage" style="height:' + imageSize + 'px; width:' + imageSize + 'px;"src="/Public/src/wedding/images/snowflake' + number1 + '.png"/>'
                        } else if (i === 22) {
                            content = '<img class="flakeimage" style="height:' + imageSize + 'px; width:' + imageSize + 'px;"src="/Public/src/wedding/images/snowflake' + number2 + '.png"/>'
                        } else if (i === 23) {
                            content = '<img class="flakeimage" style="height:' + imageSize + 'px; width:' + imageSize + 'px;"src="/Public/src/wedding/images/snowflake' + number3 + '.png"/>'
                        } else if (i === 24) {
                            content = '<img class="flakeimage" style="height:' + imageSize + 'px; width:' + imageSize + 'px;"src="/Public/src/wedding/images/snowflake' + number4 + '.png"/>'
                        } else if (i === 25) {
                            content = '<img class="flakeimage" style="height:' + imageSize + 'px; width:' + imageSize + 'px;"src="/Public/src/wedding/images/snowflake' + number5 + '.png"/>'
                        } else {
                            content = '<img class="flakeimage" style="height:' + imageSize + 'px; width:' + imageSize + 'px;"src="/Public/src/wedding/images/snowflake' + i + '.png"/>'
                        }
